...
const Home = () => {
  return (
    <>
      <section className="mx-auto max-w-6xl px-8 max-lg:px-0 py-10">
        <div className="flex max-md:flex-col w-full gap-8 max-sm:gap-10 justify-center items-center">
          <div className="w-full">
            ...
            <p className="text-xl mt-4 max-w-xl">
              Discover a smarter, faster, and more personalized way to browse products. Say goodbye to the old hassles —
              and hello to convenience, innovation, and style tailored just for you.
            </p>
            <div className="mt-8">
